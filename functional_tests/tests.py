...
class NewVisitorTest(LiveServerTestCase, TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        ## of Edith's is comming throught from cookies etc
        self.browser.quit()
        self.browser = webdriver.Firefox()
        ...
        # Edith wonders wether the site will remember her list. Then she
        # sees that site has generated a unique URL for her -- there is 
        # some explanatory text to that effect.
        # self.fail('Finish the test!')

        # She visits this URL - her to-do list is still there.
